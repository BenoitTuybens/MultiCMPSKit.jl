function leftgauge(Ψ::UniformCircularCMPS, args...; kwargs...)
    return leftgauge!(copy(Ψ), args...; kwargs...)
end
function rightgauge(Ψ::UniformCircularCMPS, args...; kwargs...)
    return rightgauge!(copy(Ψ), args...; kwargs...)
end
